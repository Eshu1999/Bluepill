...
import { MedicineStoragePageContent } from './medicine-storage-page-content';
import { Loader2 } from 'lucide-react';
import type { UserProfile, AuthUser } from '@/types';

export default function MedicineStoragePage() {
  ...
  return (
    <TooltipProvider>
        <SidebarProvider>
            <MedicineStoragePageContent user={serializableUser} profile={profile}/>
        </SidebarProvider>
    </TooltipProvider>
  );
}
